/**
 * Pipedrive Web Forms Popup Handler for Boostin
...
(function() {
  ...
  // Pipedrive form configurations - using same forms as Notifica (DPG)
  const PIPEDRIVE_FORMS = {
    ...
    demo: {
      ...
      defaultMessage: "Ik wil graag een demo sessie plannen. (Via Boostin website)"
    },
    training: {
      title: "Inschrijven voor training",
      subtitle: "Vul onderstaand formulier in om je in te schrijven.",
      url: "https://webforms.pipedrive.com/f/6zmGQ2X1XW91oGi0OQQ0vma5UHXZGOy6qV6Z5KEIv8DppStJUhO0CP4sMxRkcUl0LV"
    }
  };
  ...
  function openPopup(formId, context = {}) {
    ...
    container.innerHTML = `
      ${form.title ? `<h2 style="margin-bottom: ${form.subtitle ? "12px" : "24px"}; color: #ff144f;">${form.title}</h2>` : ""}
